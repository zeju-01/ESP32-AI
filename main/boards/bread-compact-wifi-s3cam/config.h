...
#define AUDIO_I2S_GPIO_DIN      GPIO_NUM_10   // I2S数据输入（ES8374 DOUT → ESP32 DIN，麦克风数据）
#define AUDIO_I2S_GPIO_DOUT     GPIO_NUM_8    // I2S数据输出（ESP32 DOUT → ES8374 DIN，扬声器数据）
...
#define BOOT_BUTTON_GPIO        GPIO_NUM_NC  // GPIO_NUM_0 conflicts with DISPLAY_MOSI_PIN, button moved to PCA9555
...
// 默认配置：如果没有选择任何LCD配置，使用ST7789 320x172
#if !defined(LCD_TYPE_ST7789_SERIAL) && !defined(LCD_TYPE_ILI9341_SERIAL) && !defined(LCD_TYPE_GC9A01_SERIAL)
#define LCD_TYPE_ST7789_SERIAL
#define DISPLAY_WIDTH   320
#define DISPLAY_HEIGHT  172
#define DISPLAY_MIRROR_X false
